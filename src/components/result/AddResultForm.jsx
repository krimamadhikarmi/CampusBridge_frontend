...
const AddResultForm = ({ handleResultPop }) => {
  ...
  const handleSubmit = () =>{
    const resultData = {
      ResultId,ExamType,Semester,Percentage,Status,StudentId
    };
    handleResultSubmit(resultData);
  }
  return (
    <div className="form-overlay">
      <div className="form-design">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <CustomFormField name={'StudentID'} label={'Student Id'} placeholder={'Enter the Student Id'} type={'text'} onChange={(e)=>setStudentId(e.target.value)}/>
